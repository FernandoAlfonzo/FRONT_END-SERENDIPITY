		...
		@section("wrapper")
            <div class="page-wrapper">
                <div class="page-content">
                    <h6 class="mb-0 text-uppercase" style="color: #223175;font-weight: bold;">Mensajes</h6>
                    <hr/>
                    <!--start email wrapper-->
                        ...
                        <div class="email-sidebar">
                            ...
                            <div class="email-sidebar-content">
                                <div class="email-navigation">
                                    <div class="list-group list-group-flush"> <a href="{{ url('bandeja') }}" class="list-group-item active d-flex align-items-center"><i class='bx bxs-inbox me-3 font-20'></i><span>Bandeja</span><span class="badge bg-primary rounded-pill ms-auto">3</span></a>
                                        <a href="{{ url('enviados') }}" class="list-group-item d-flex align-items-center"><i class='bx bxs-send me-3 font-20'></i><span>Enviados</span></a>
                                        <a href="{{ url('eliminados') }}" class="list-group-item d-flex align-items-center"><i class='bx bxs-trash-alt me-3 font-20'></i><span>Eliminados</span></a>
                                    </div>
                                </div>
